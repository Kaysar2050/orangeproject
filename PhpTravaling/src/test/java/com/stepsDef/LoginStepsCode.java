...
public class LoginStepsCode {
	...
	public void user_click_on_the_Home_button() throws Throwable {
		// action.moveToElement(driver.findElement(By.xpath("//[@title =
	...
	public void user_Select_destination_as_Dubai_United_Arab_Emirates() throws Throwable {
		...
		//WebElement selectBox = driver.findElement(By.xpath("//*[@id=\"s2id_autogen16\"]/a/span[1]"));
		//selectBox.click();
		
		WebElement selectt = driver.findElement(By.xpath("//div[@id='s2id_autogen16']/a"));
		selectt.click();
		//WebElement select = driver.findElement(By.xpath("//*[@id='select2-drop']/div/input"));
		//select.click();
